...
{
    public MCH_ItemContainer(final int par1) {
        super(par1);
        this.maxStackSize = 1;
    }
    ...
    public ItemStack onItemRightClick(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3EntityPlayer) {
        ...
        if (W_MovingObjectPosition.isHitTypeTile(movingobjectposition)) {
            ...
            final MCH_EntityContainer entityboat = new MCH_EntityContainer(par2World, (double)(i + 0.5f), (double)(j + 1.0f), (double)(k + 0.5f));
            entityboat.rotationYaw = (float)(((MathHelper.floor_double(par3EntityPlayer.rotationYaw * 4.0f / 360.0f + 0.5) & 0x3) - 1) * 90);
