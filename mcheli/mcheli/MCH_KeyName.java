...
public class MCH_KeyName
{
    ...
    private static MCH_KeyName[] list;
    
    private MCH_KeyName(final int v, final String n, final String d) {
        this.value = v;
    ...
    public static int getValue(final String name) {
        ...
        for (final MCH_KeyName key : MCH_KeyName.list) {
    ...
    public static String getDescOrName(final int value) {
        for (final MCH_KeyName key : MCH_KeyName.list) {
            if (key.value == value) {
