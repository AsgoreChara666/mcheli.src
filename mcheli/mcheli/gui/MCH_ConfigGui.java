...
public class MCH_ConfigGui extends W_GuiContainer
{
    ...
    public void initGui() {
        ...
        final int x1 = this.guiLeft + 10;
        final int x2 = this.guiLeft + 10 + 150 + 10;
    ...
    public void sendClientSettings() {
        if (this.mc.thePlayer != null) {
            final MCH_EntityAircraft ac = MCH_EntityAircraft.getAircraft_RiddenOrControl((Entity)this.mc.thePlayer);
            if (ac != null) {
                final int seatId = ac.getSeatIdByEntity((Entity)this.mc.thePlayer);
                if (seatId == 0) {
    ...
    public void keyTyped(final char a, final int code) {
            ...
            switch (button.id) {
                ...
                case 400: {
                    ...
                    if (ac != null && ac.getAcInfo() != null) {
                        ...
                        final List list = this.mc.theWorld.loadedEntityList;
                ...
                case 401: {
                    ...
                    final List list2 = this.mc.theWorld.loadedEntityList;
    ...
    public void drawTexturedModalRectRotate(final double left, final double top, final double width, final double height, final double uLeft, final double vTop, final double uWidth, final double vHeight, final float rot, final double texWidth, final double texHeight) {
        ...
        tessellator.addVertexWithUV(-width / 2.0, height / 2.0, (double)this.zLevel, uLeft * fw, (vTop + vHeight) * fh);
        tessellator.addVertexWithUV(width / 2.0, height / 2.0, (double)this.zLevel, (uLeft + uWidth) * fw, (vTop + vHeight) * fh);
        tessellator.addVertexWithUV(width / 2.0, -height / 2.0, (double)this.zLevel, (uLeft + uWidth) * fw, vTop * fh);
        tessellator.addVertexWithUV(-width / 2.0, -height / 2.0, (double)this.zLevel, uLeft * fw, vTop * fh);
        tessellator.draw();
        GL11.glPopMatrix();
    }
}
