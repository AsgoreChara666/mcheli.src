...
public class MCH_Achievement
{
    ...
    public static void PreInit() {
        ...
        W_LanguageRegistry.addNameForObject(MCH_Achievement.supplyFuel = W_Achievement.registerAchievement("mcheli" + name, name, -1, 1, (Item)MCH_MOD.itemFuel, null), "en_US", "Refueling", name, "Refuel aircraft");
        ...
        item = (Item)MCH_MOD.itemContainer;
    ...
    public static Item getAircraftIcon(final String defaultIconAircraft) {
        ...
        MCH_AircraftInfo info = (MCH_AircraftInfo)MCH_HeliInfoManager.get(defaultIconAircraft);
    ...
    public static void addStat(final Entity player, final Achievement a, final int i) {
        if (a != null && player instanceof EntityPlayer && !player.worldObj.isRemote) {
            ((EntityPlayer)player).addStat((StatBase)a, i);
        }
    }
