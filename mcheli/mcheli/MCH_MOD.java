...
public class MCH_MOD
{
    ...
    public void PreInit(final FMLPreInitializationEvent evt) {
        ...
        W_ItemList.init();
        MCH_MOD.proxy.loadConfig("config/mcheli.cfg");
        MCH_MOD.config = MCH_MOD.proxy.config;
        ...
        (MCH_MOD.blockDraftingTable = new MCH_DraftingTableBlock(MCH_Config.BlockID_DraftingTableOFF.prmInt, false)).setUnlocalizedName("drafting_table");
        MCH_MOD.blockDraftingTable.setCreativeTab((CreativeTabs)MCH_MOD.creativeTabs);
        final MCH_Config config2 = MCH_MOD.config;
        (MCH_MOD.blockDraftingTableLit = new MCH_DraftingTableBlock(MCH_Config.BlockID_DraftingTableON.prmInt, true)).setUnlocalizedName("lit_drafting_table");
    ...
    public void registerEntity() {
        EntityRegistry.registerModEntity((Class)MCH_EntitySeat.class, "MCH.E.Seat", 100, (Object)this, 400, 10, true);
        EntityRegistry.registerModEntity((Class)MCH_EntityHeli.class, "MCH.E.Heli", 101, (Object)this, 400, 10, true);
        EntityRegistry.registerModEntity((Class)MCH_EntityGLTD.class, "MCH.E.GLTD", 102, (Object)this, 200, 10, true);
        EntityRegistry.registerModEntity((Class)MCP_EntityPlane.class, "MCH.E.Plane", 103, (Object)this, 400, 10, true);
        ...
        EntityRegistry.registerModEntity((Class)MCH_EntityVehicle.class, "MCH.E.Vehicle", 108, (Object)this, 400, 10, true);
        EntityRegistry.registerModEntity((Class)MCH_EntityUavStation.class, "MCH.E.UavStation", 109, (Object)this, 400, 10, true);
        ...
        EntityRegistry.registerModEntity((Class)MCH_EntityTank.class, "MCH.E.Tank", 112, (Object)this, 400, 10, true);
        ...
        EntityRegistry.registerModEntity((Class)MCH_EntityGunner.class, "MCH.E.Gunner", 500, (Object)this, 530, 5, true);
    }
    ...
    private void registerItemSpawnGunner() {
        ...
        registerItem(MCH_MOD.itemSpawnGunnerVsMonster = item, name, MCH_MOD.creativeTabs);
        ...
        registerItem(MCH_MOD.itemSpawnGunnerVsPlayer = item, name, MCH_MOD.creativeTabs);
    ...
    public void registerItemInvisible() {
        ...
        registerItem((W_Item)(MCH_MOD.invisibleItem = item), "internal", null);
    }
    ...
    public void registerItemContainer() {
        ...
        registerItem((W_Item)(MCH_MOD.itemContainer = item), "container", MCH_MOD.creativeTabs);
    ...
    public void registerItemLightWeapon() {
        ...
        registerItem((W_Item)(MCH_MOD.itemStinger = item), name, MCH_MOD.creativeTabs);
        ...
        registerItem((W_Item)(MCH_MOD.itemJavelin = item), name, MCH_MOD.creativeTabs);
    ...
    public void registerItemLightWeaponBullet() {
        ...
        registerItem((W_Item)(MCH_MOD.itemStingerBullet = item), name, MCH_MOD.creativeTabs);
        ...
        registerItem((W_Item)(MCH_MOD.itemJavelinBullet = item), name, MCH_MOD.creativeTabs);
    ...
    public void registerItemChain() {
        ...
        registerItem((W_Item)(MCH_MOD.itemChain = item), "chain", MCH_MOD.creativeTabs);
    ...
    public void registerItemFuel() {
        ...
        registerItem((W_Item)(MCH_MOD.itemFuel = item), "fuel", MCH_MOD.creativeTabs);
    ...
    public void registerItemGLTD() {
        ...
        registerItem((W_Item)(MCH_MOD.itemGLTD = item), "gltd", MCH_MOD.creativeTabs);
    ...
    public static void registerItem(final W_Item item, final String name, final MCH_CreativeTabs ct) {
        ...
        if (ct != null) {
            item.setCreativeTab((CreativeTabs)ct);
    ...
    public static void registerItemThrowable() {
        for (final String name : MCH_ThrowableInfoManager.getKeySet()) {
            ...
            (info.item = new MCH_ItemThrowable(info.itemID)).setMaxStackSize(info.stackSize);
    ...
    public static void registerItemAircraft() {
        for (final String name : MCH_HeliInfoManager.map.keySet()) {
            ...
            (info.item = new MCH_ItemHeli(info.itemID)).setMaxDurability(info.maxHp);
            if (!info.canRide && (info.ammoSupplyRange > 0.0f || info.fuelSupplyRange > 0.0f)) {
                registerItem((W_Item)info.item, name, MCH_MOD.creativeTabs);
            }
            else {
                registerItem((W_Item)info.item, name, MCH_MOD.creativeTabsHeli);
            }
        ...
        for (final String name : MCP_PlaneInfoManager.map.keySet()) {
            ...
            (info2.item = new MCP_ItemPlane(info2.itemID)).setMaxDurability(info2.maxHp);
            if (!info2.canRide && (info2.ammoSupplyRange > 0.0f || info2.fuelSupplyRange > 0.0f)) {
                registerItem((W_Item)info2.item, name, MCH_MOD.creativeTabs);
            }
            else {
                registerItem((W_Item)info2.item, name, MCH_MOD.creativeTabsPlane);
            }
            MCH_ItemAircraft.registerDispenseBehavior((Item)info2.item);
            info2.itemID = W_Item.getIdFromItem((Item)info2.item) - 256;
        ...
        for (final String name : MCH_TankInfoManager.map.keySet()) {
            ...
            (info3.item = new MCH_ItemTank(info3.itemID)).setMaxDurability(info3.maxHp);
            if (!info3.canRide && (info3.ammoSupplyRange > 0.0f || info3.fuelSupplyRange > 0.0f)) {
                registerItem((W_Item)info3.item, name, MCH_MOD.creativeTabs);
            }
            else {
                registerItem((W_Item)info3.item, name, MCH_MOD.creativeTabsTank);
            }
            MCH_ItemAircraft.registerDispenseBehavior((Item)info3.item);
            info3.itemID = W_Item.getIdFromItem((Item)info3.item) - 256;
        ...
        for (final String name : MCH_VehicleInfoManager.map.keySet()) {
            ...
            (info4.item = new MCH_ItemVehicle(info4.itemID)).setMaxDurability(info4.maxHp);
            if (!info4.canRide && (info4.ammoSupplyRange > 0.0f || info4.fuelSupplyRange > 0.0f)) {
                registerItem((W_Item)info4.item, name, MCH_MOD.creativeTabs);
            }
            else {
                registerItem((W_Item)info4.item, name, MCH_MOD.creativeTabsVehicle);
            }
            MCH_ItemAircraft.registerDispenseBehavior((Item)info4.item);
            info4.itemID = W_Item.getIdFromItem((Item)info4.item) - 256;
