...
public class MCH_ClientProxy extends MCH_CommonProxy
{
    ...
    public void registerRenderer() {
        ...
        RenderingRegistry.registerEntityRenderingHandler((Class)MCH_EntityGunner.class, (Render)new MCH_RenderGunner());
    ...
    public void registerClientTick() {
        ...
        W_TickRegistry.registerTickHandler((W_TickHandler)(MCH_ClientCommonTickHandler.instance = new MCH_ClientCommonTickHandler(mc, MCH_MOD.config)), Side.CLIENT);
    }
    ...
    public MCH_SoundUpdater CreateSoundUpdater(final MCH_EntityAircraft aircraft) {
        if (aircraft == null || !aircraft.worldObj.isRemote) {
            return null;
        }
        return new MCH_SoundUpdater(Minecraft.getMinecraft(), aircraft, (EntityPlayerSP)Minecraft.getMinecraft().thePlayer);
    }
    ...
    public void loadConfig(final String fileName) {
        ...
        (this.config = new MCH_Config(Minecraft.getMinecraft().mcDataDir.getPath(), "/" + fileName)).load();
        this.config.write();
    }
