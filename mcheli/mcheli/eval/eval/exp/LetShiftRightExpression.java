...
public class LetShiftRightExpression extends ShiftRightExpression
{
    ...
    protected LetShiftRightExpression(final LetShiftRightExpression from, final ShareExpValue s) {
        super(from, s);
    }
    
    @Override
    public AbstractExpression dup(final ShareExpValue s) {
        return (AbstractExpression)new LetShiftRightExpression(this, s);
    }
