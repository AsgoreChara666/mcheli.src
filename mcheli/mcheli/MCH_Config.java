...
public class MCH_Config
{
    ...
    public MCH_Config(final String minecraftPath, final String cfgFile) {
        ...
        MCH_Config.DespawnCount = new MCH_ConfigPrm("DespawnCount", 25);
        MCH_Config.HitBoxDelayTick = new MCH_ConfigPrm("HitBoxDelayTick", 0);
        MCH_Config.EnableRotationLimit = new MCH_ConfigPrm("EnableRotationLimit", false);
        MCH_Config.PitchLimitMax = new MCH_ConfigPrm("PitchLimitMax", 10);
        MCH_Config.PitchLimitMin = new MCH_ConfigPrm("PitchLimitMin", -10);
        MCH_Config.RollLimit = new MCH_ConfigPrm("RollLimit", 35);
        MCH_Config.RangeOfGunner_VsMonster_Horizontal = new MCH_ConfigPrm("RangeOfGunner_VsMonster_Horizontal", 80);
        MCH_Config.RangeOfGunner_VsMonster_Vertical = new MCH_ConfigPrm("RangeOfGunner_VsMonster_Vertical", 160);
        MCH_Config.RangeOfGunner_VsPlayer_Horizontal = new MCH_ConfigPrm("RangeOfGunner_VsPlayer_Horizontal", 200);
        MCH_Config.RangeOfGunner_VsPlayer_Vertical = new MCH_ConfigPrm("RangeOfGunner_VsPlayer_Vertical", 300);
        MCH_Config.FixVehicleAtPlacedPoint = new MCH_ConfigPrm("FixVehicleAtPlacedPoint", true);
        MCH_Config.KillPassengersWhenDestroyed = new MCH_ConfigPrm("KillPassengersWhenDestroyed", false);
        ...
        MCH_Config.ItemRecipe_GunnerVsMonster = new MCH_ConfigPrm("ItemRecipe_GunnerVsMonster", "\"EI\", E, egg, I, iron_block");
        MCH_Config.ItemRecipe_GunnerVsPlayer = new MCH_ConfigPrm("ItemRecipe_GunnerVsPlayer", "\"EG\", E, egg, G, gold_block");
    ...
    public void correctionParameter() {
        ...
        MCH_Config.PitchLimitMax.prmInt = ((MCH_Config.PitchLimitMax.prmInt > 80) ? 80 : ((MCH_Config.PitchLimitMax.prmInt < 0) ? 0 : MCH_Config.PitchLimitMax.prmInt));
        MCH_Config.PitchLimitMin.prmInt = ((MCH_Config.PitchLimitMin.prmInt < -80) ? -80 : ((MCH_Config.PitchLimitMin.prmInt > 0) ? 0 : MCH_Config.PitchLimitMin.prmInt));
        MCH_Config.RollLimit.prmInt = ((MCH_Config.RollLimit.prmInt > 80) ? 80 : ((MCH_Config.RollLimit.prmInt < 0) ? 0 : MCH_Config.RollLimit.prmInt));
    ...
    public static float applyDamageByExternal(final Entity target, final DamageSource ds, float damage) {
        ...
        final Entity attackerSource = ds.getSourceOfDamage();
