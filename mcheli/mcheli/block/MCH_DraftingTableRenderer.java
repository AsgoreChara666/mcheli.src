...
{
    public void renderTileEntityAt(final TileEntity tile, final double posX, final double posY, final double posZ, final float var8) {
        GL11.glPushMatrix();
        GL11.glEnable(2884);
        GL11.glTranslated(posX + 0.5, posY, posZ + 0.5);
        final float yaw = (float)(-tile.getBlockMetadata() * 45 + 180);
