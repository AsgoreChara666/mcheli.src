...
{
    public void doRender(final Entity e, final double var2, final double var4, final double var6, final float var8, final float var9) {
        if (e instanceof MCH_EntityBaseBullet && ((MCH_EntityBaseBullet)e).getInfo() != null) {
            MCH_Color c = ((MCH_EntityBaseBullet)e).getInfo().color;
            for (int y = 0; y < 3; ++y) {
                final Block b = W_WorldFunc.getBlock(e.worldObj, (int)(e.posX + 0.5), (int)(e.posY + 1.5 - y), (int)(e.posZ + 0.5));
