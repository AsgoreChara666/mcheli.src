...
public class MCH_MultiplayClient
{
    ...
    public static void sendScreenShot(int displayWidth, int displayHeight, final Framebuffer framebufferMc) {
        try {
            ...
            if (OpenGlHelper.isFramebufferEnabled()) {
                ...
                int i1;
                for (int l = i1 = framebufferMc.framebufferTextureHeight - framebufferMc.framebufferHeight; i1 < framebufferMc.framebufferTextureHeight; ++i1) {
            ...
            ImageIO.write(bufferedimage, "png", (OutputStream)(MCH_MultiplayClient.dataOutputStream = new MCH_OStream()));
        }
        catch (Exception ex) {}
    }
    ...
    public static double getPerData() {
        return (MCH_MultiplayClient.dataOutputStream == null) ? -1.0 : (MCH_MultiplayClient.dataOutputStream.index / (double)MCH_MultiplayClient.dataOutputStream.size());
    }
    
    public static void readModList(final String playerName, final String commandSenderName) {
        (MCH_MultiplayClient.modList = new ArrayList<String>()).add(EnumChatFormatting.RED + "###### Name:" + commandSenderName + " ######");
        MCH_MultiplayClient.modList.add(EnumChatFormatting.RED + "###### ID  :" + playerName + " ######");
        final String[] arr$;
    ...
    public static void sendModsInfo(final String playerName, final String commandSenderName, final int id) {
