...
Invulnerable = true
; 機体が無敵になる。
; マルチプレイで拠点の防衛兵器などに使用するとよい。

CreativeOnly = true
; クリエイティブのプレイヤーしか設置やアイテム化ができなくなる。
...
ThirdPersonDist = 12
;3人称視点時のデフォルト距離を指定する。
;ヘリMODではPageUp/Downで4ブロック分距離を変更するため、4の倍数を推奨
...
;機体の縦方向の回転限界(最小・最大)
;※ ヘリコプターと戦闘機はこの設定を有効にするとロールにも制限がかかる
...
;※ ヘリコプターと戦闘機はこの設定を有効にすると縦方向の回転にも制限がかかる
